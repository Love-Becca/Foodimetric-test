...
const GoogleBtn = () => {
    return (
        <button class="border border-gray-500 hover:border-gray-700 text-gray-500 hover:text-gray-700 font-semibold py-2 px-4 rounded inline-flex items-center gap-2">
