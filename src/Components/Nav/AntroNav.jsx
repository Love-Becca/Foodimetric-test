                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <NavLink
                                        ...
                                        ${isActive ? 'bg-[#147e03] text-white' : 'bg-white hover:bg-green-50 text-gray-900'}`}
                                    >
